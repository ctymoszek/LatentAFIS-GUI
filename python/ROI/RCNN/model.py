...
def fullmatch2(regex, string, flags=0):
    """Emulate python-3.4 re.fullmatch()."""
...
class MaskRCNN():
    ...
    def unmold_detections(self, detections, mrcnn_mask, image_shape, window, threshold_mask = 0.5):
        ...
        for i in range(N):
            ...
            full_mask = utils.unmold_mask(masks[i], boxes[i], image_shape, threshold_mask)
    ...
    def detect(self, images, verbose=0, threshold_mask = 0.5):
        ...
        for i, image in enumerate(images):
            final_rois, final_class_ids, final_scores, final_masks =\
                self.unmold_detections(detections[i], mrcnn_mask[i],
                                       image.shape, windows[i], threshold_mask)
            results.append({
                "rois": final_rois,
    ...
    def ancestor(self, tensor, name, checked=None):
        ...
        for p in parents:
            ...
            if (fullmatch2(name, p.name)!= None):
                return p
            checked.append(p)
